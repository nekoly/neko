...
if __name__ == '__main__':
     ...
     for i in range(1,1951):
         ...
         #1224
         # url = "https://www.ikjzd.com/a/13687.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         # url = "https://www.ikjzd.com/a/13688.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         #蓝牙耳机+600
         # url = "https://www.ikjzd.com/a/13694.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         #1225Pressure Washers
         # url = "https://www.ikjzd.com/a/13754.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         # url = "https://www.ikjzd.com/a/13755.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         #1226
         # url = "https://www.ikjzd.com/a/13841.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)
         #单品

         # url = "https://www.ikjzd.com/a/13838.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         # url = "https://www.ikjzd.com/a/13837.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)

         #1227
         # url = "https://www.ikjzd.com/a/13941.html"
         # resp = requests.get(url, headers=unicornHeader, timeout=30)
         #精品
         ...
         url = "https://www.ikjzd.com/a/14013.html"
         resp = requests.get(url, headers=unicornHeader, timeout=30)

         url = "https://www.ikjzd.com/a/14012.html"
         resp = requests.get(url, headers=unicornHeader, timeout=30)
